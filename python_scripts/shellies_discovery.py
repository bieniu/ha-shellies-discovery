...
SENSOR_MINIMAL_VALVE_REPORT = "minimal_valve_report"
...
TPL_VALVE_MIN_REPORT = "{{value_json.thermostats.0.valve_min_report}}"
TPL_VALVE_POSITION = (
...
OPTIONS_SENSOR_MINIMAL_VALVE_REPORT = {
    KEY_ENABLED_BY_DEFAULT: True,
    KEY_ENTITY_CATEGORY: ENTITY_CATEGORY_CONFIG,
    KEY_STATE_CLASS: STATE_CLASS_MEASUREMENT,
    KEY_STATE_TOPIC: TOPIC_SETTINGS,
    KEY_UNIT: UNIT_PERCENT,
    KEY_VALUE_TEMPLATE: TPL_VALVE_MIN_REPORT,
}
...
if model_id == MODEL_SHELLYVALVE_ID:
    ...
    sensors = {
        ...
        SENSOR_MINIMAL_VALVE_REPORT: OPTIONS_SENSOR_MINIMAL_VALVE_REPORT,
    }
    binary_sensors = {
        SENSOR_CHARGER: OPTIONS_SENSOR_CHARGER,
        SENSOR_CLOUD: OPTIONS_SENSOR_CLOUD,
