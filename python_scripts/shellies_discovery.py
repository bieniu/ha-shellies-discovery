...
for light_id in range(rgbw_lights):
    ...
    if mode == LIGHT_COLOR and model == MODEL_SHELLYRGBW2:
        ...
        payload = (
            ...
            '"cmd_off_tpl":"{\\"turn\\":\\"off\\",\\"mode\\":\\"color\\",\\"effect\\": 0{%if transition is defined%},\\"transition\\":{{transition|multiply(1000)}}{%endif%}}",'
...
for light_id in range(white_lights):
    ...
    if mode == LIGHT_WHITE and model == MODEL_SHELLYRGBW2:
        payload = (
            ...
            '"pl_avail":"true",'
            '"pl_not_avail":"false",'
            '"cmd_on_tpl":"{\\"turn\\":\\"on\\"{%if brightness is defined%},\\"brightness\\":{{brightness|float|multiply(0.3922)|round}}{%endif%}{%if white_value is defined%},\\"white\\":{{white_value}}{%endif%}{%if effect is defined%},\\"effect\\":{{effect}}{%endif%}{%if transition is defined%},\\"transition\\":{{transition|multiply(1000)}}{%endif%}}",'
            '"cmd_off_tpl":"{\\"turn\\":\\"off\\"{%if transition is defined%},\\"transition\\":{{transition|multiply(1000)}}{%endif%}}",'
            '"stat_tpl":"{%if value_json.ison%}on{%else%}off{%endif%}",'
        ...
        payload = (
            ...
            '"pl_avail":"true",'
            '"pl_not_avail":"false",'
            '"cmd_on_tpl":"{\\"turn\\":\\"on\\"{%if brightness is defined%},\\"brightness\\":{{brightness|float|multiply(0.3922)|round}}{%endif%}{%if transition is defined%},\\"transition\\":{{transition|multiply(1000)}}{%endif%}}",'
            '"cmd_off_tpl":"{\\"turn\\":\\"off\\"{%if transition is defined%},\\"transition\\":{{transition|multiply(1000)}}{%endif%}}",'
            '"stat_tpl":"{%if value_json.ison%}on{%else%}off{%endif%}",'
            '"bri_tpl":"{{value_json.brightness|float|multiply(2.55)|round}}",'
            '"uniq_id":"' + unique_id + '",'
        ...
        payload = (
            ...
            '"pl_avail":"true",'
            '"pl_not_avail":"false",'
            '"cmd_on_tpl":"{\\"turn\\":\\"on\\"{%if brightness is defined%},\\"brightness\\":{{brightness|float|multiply(0.3922)|round}}{%endif%}{%if color_temp is defined%},\\"temp\\":{{(1000000/(color_temp|int))|round(0,\\"floor\\")}}{%endif%}{%if transition is defined%},\\"transition\\":{{transition|multiply(1000)}}{%endif%}}",'
            '"cmd_off_tpl":"{\\"turn\\":\\"off\\"{%if transition is defined%},\\"transition\\":{{transition|multiply(1000)}}{%endif%}}",'
            '"stat_tpl":"{%if value_json.ison%}on{%else%}off{%endif%}",'
            '"bri_tpl":"{{value_json.brightness|float|multiply(2.55)|round}}",'
