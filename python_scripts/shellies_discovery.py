...
SENSOR_WINDOW_STATUS_REPORTING = "window_status_reporting"
...
OPTIONS_SENSOR_WINDOW_STATUS_REPORTING = {
    KEY_ENABLED_BY_DEFAULT: False,
    KEY_ENTITY_CATEGORY: ENTITY_CATEGORY_DIAGNOSTIC,
    KEY_NAME: "Window status reporting",
    KEY_STATE_TOPIC: TOPIC_SETTINGS,
    KEY_VALUE_TEMPLATE: TPL_WINDOW_STATUS_REPORTING,
}
...
if model_id == MODEL_SHELLYVALVE_ID:
    ...
    binary_sensors = {
        ...
        SENSOR_WINDOW_STATUS_REPORTING: OPTIONS_SENSOR_WINDOW_STATUS_REPORTING,
        "firmware update": {},
    }
    buttons = {
        BUTTON_RESTART: OPTIONS_BUTTON_RESTART,
