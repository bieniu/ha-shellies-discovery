...
TPL_CONCENTRATION = "{%if is_number(value) and 0<=value<=65535%}{{value}}{%endif%}"
...
TPL_HUMIDITY = "{%if is_number(value) and 0<value<999%}{{value}}{%endif%}"
TPL_HUMIDITY_EXT = "{%if is_number(value) and 0<value<999%}{{value}}{%endif%}"
...
TPL_TEMPERATURE = "{%if is_number(value) and -100<value<900%}{{value}}{%endif%}"
TPL_TEMPERATURE_MOTION = "{{value_json.tmp.value}}"
TPL_TEMPERATURE_EXT = "{%if is_number(value) and -100<value<999%}{{value}}{%endif%}"
